#!/usr/bin/env python3
"""Run 2_html_replace_image_urls_lance locally on a Lance dataset."""
...
PIPE_NAME = "stage2_html_replace_image_urls_lance"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=Path,
        default=ROOT / "workspace" / "html_lance" / "wiki_0320_en_has_pic_localized",
    )
