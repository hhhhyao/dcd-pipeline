#!/usr/bin/env python3
"""Run stage4_md_to_openai locally on a Lance dataset."""
...
import pipelines.wiki.stage4_md_to_openai as PIPE_MODULE  # noqa: E402

PIPE_NAME = "stage4_md_to_openai"
...
def run(
    ...
    *,
    ...
    print(
        ...
        f"max_small_area: {max_small_area}, message_role: {message_role}, "
        f"workers: {workers}",
    )
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=int,
        default=784,
        help="Drop images with width*height <= this (default 28*28)",
    )
    parser.add_argument(
        "--message-role",
        default="user",
    ...
    run(
        ...
        max_small_area=max(0, args.max_small_area),
