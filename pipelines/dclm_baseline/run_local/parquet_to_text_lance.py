#!/usr/bin/env python3
"""Run DCLM baseline parquet -> DCD text.lance conversion locally."""
...
from pipelines.dclm_baseline.parquet_to_text_lance import main as pipe  # noqa: E402

DEFAULT_SOURCE_DIR = Path("/root/yaolewei/code/data_process/fineweb_index/workspace/data/dclm_baseline_parquet")
DEFAULT_OUTPUT_DIR = ROOT / "workspace" / "text_lance" / "dclm-baseline"
...
def run(
    *,
    ...
    with tempfile.TemporaryDirectory(prefix=".dclm_lance_shards_", dir=str(output_dir.parent)) as temp_dir:
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Convert DCLM baseline parquet to DCD text.lance")
