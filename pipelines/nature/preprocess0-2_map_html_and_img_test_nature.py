...
def resolve_image_url_for_page(page_url: str, img_url: str, page_final_url: str) -> str:
    """Fix Nature immersive article asset URLs from older preprocess0-1 mappings."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build Nature raw_data JSONL+TAR from preprocess0-1 page image mappings.",
    )
