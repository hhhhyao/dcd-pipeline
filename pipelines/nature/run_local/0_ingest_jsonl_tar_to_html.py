#!/usr/bin/env python3
"""Run the raw Nature jsonl+tar -> html Lance ingest stage locally."""
...
from pipelines.nature.stage0_ingest_jsonl_tar_to_html import ingest  # noqa: E402
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=Path,
        default=Path("/root/zhouyiren/data/interleaved/nature/raw_data"),
    )
    parser.add_argument(
        "dst_dir",
        nargs="?",
        type=Path,
        default=Path("/root/zhouyiren/data/interleaved/nature/html_lance/nature_test_v1"),
    )
    ...
    ctx = PipeContext(
        ...
        pipe_name="nature_stage0_ingest_jsonl_tar_to_html",
        pipe_version=1,
        output_dir=dst_dir,
        config={
