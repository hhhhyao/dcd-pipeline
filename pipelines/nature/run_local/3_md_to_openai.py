...
import pipelines.nature.stage3_md_to_openai as PIPE_MODULE  # noqa: E402

PIPE_NAME = "nature_stage3_md_to_openai"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=Path,
        default=Path("/root/zhouyiren/data/interleaved/nature/md_lance/nature_test_v1_md"),
    )
    parser.add_argument(
        "dst_dataset_dir",
        nargs="?",
