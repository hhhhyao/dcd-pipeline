...
DEFAULT_INPUT_DIR = "/root/zhouyiren/data/interleaved/nature/html_lance/nature_test_v1"
DEFAULT_OUTPUT_DIR = "/root/zhouyiren/data/interleaved/nature/html_lance/nature_test_v1_localized"
...
DEFAULT_EXTRACTOR = "plugins.nature_production:extract_img_urls_from_html"
DEFAULT_NORMALIZER = "plugins.nature_production:normalize_image_url"
DEFAULT_FORMATTER = "plugins.nature_production:format_image_ref"
DEFAULT_REWRITER = "plugins.nature_production:rewrite_html"
...
def _parse_info(info_raw: Any) -> dict[str, Any]:
...
def _parse_rows_from_pylist(batch_rows: list[dict[str, Any]]) -> tuple[list[dict[str, Any]], int, int]:
    ...
    for row in batch_rows:
        info = _parse_info(row.get("info") or "{}")
