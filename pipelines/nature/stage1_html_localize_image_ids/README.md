# nature_stage1_html_localize_image_ids

Rewrite Nature HTML image references from remote URLs to local
...
The default plugin is `plugins.nature_production`. It normalizes common Nature
...
```bash
python3 pipelines/nature/run_local/1_html_localize_image_ids.py \
