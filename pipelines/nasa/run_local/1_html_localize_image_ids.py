...
import pipelines.nasa.stage1_html_localize_image_ids as PIPE_MODULE  # noqa: E402

PIPE_NAME = "nasa_stage1_html_localize_image_ids"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=Path,
        default=Path("/root/zhouyiren/data/interleaved/nasa/html_lance/nasa_test_v1_localized"),
    )
