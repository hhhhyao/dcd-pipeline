...
import pipelines.nasa.stage4_filter_images as PIPE_MODULE  # noqa: E402
try:
...
PIPE_NAME = "nasa_stage4_filter_images"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=Path,
        default=Path("/root/zhouyiren/data/interleaved/nasa/openai_lance/nasa_test_v1_openai"),
    )
    parser.add_argument(
        "dst_dataset_dir",
        nargs="?",
        type=Path,
        default=Path("/root/zhouyiren/data/interleaved/nasa/openai_lance/nasa_test_v1_openai_filtered"),
    )
