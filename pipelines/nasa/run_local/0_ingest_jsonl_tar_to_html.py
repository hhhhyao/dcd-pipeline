#!/usr/bin/env python3
"""Run the raw NASA jsonl+tar -> html Lance ingest stage locally."""
...
from pipelines.nasa.stage0_ingest_jsonl_tar_to_html import ingest  # noqa: E402
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=Path,
        default=Path("/root/zhouyiren/data/interleaved/nasa/raw_data"),
    )
    parser.add_argument(
        "dst_dir",
        nargs="?",
        type=Path,
        default=Path("/root/zhouyiren/data/interleaved/nasa/html_lance/nasa_test_v1"),
    )
    ...
    ctx = PipeContext(
        ...
        pipe_name="nasa_stage0_ingest_jsonl_tar_to_html",
        pipe_version=1,
        output_dir=dst_dir,
        config={
