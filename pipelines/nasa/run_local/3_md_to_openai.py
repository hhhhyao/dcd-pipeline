...
import pipelines.nasa.stage3_md_to_openai as PIPE_MODULE  # noqa: E402

PIPE_NAME = "nasa_stage3_md_to_openai"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=Path,
        default=Path("/root/zhouyiren/data/interleaved/nasa/md_lance/nasa_test_v1_md"),
    )
    parser.add_argument(
        "dst_dataset_dir",
        nargs="?",
