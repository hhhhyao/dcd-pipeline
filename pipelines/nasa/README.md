...
This directory contains DCD pipes and local helpers for processing NASA
...
- `stage1_html_localize_image_ids`: rewrite NASA HTML image references to
...
/root/zhouyiren/data/interleaved/nasa/raw_data
  ...
  -> /root/zhouyiren/data/interleaved/nasa/openai_lance/nasa_test_v1_openai_filtered
```
